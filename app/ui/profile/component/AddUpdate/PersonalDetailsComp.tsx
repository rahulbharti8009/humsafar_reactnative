...
const minDate = new Date(
  ...
  const renderInput = ({placeholder, key, isEditable = true}: {placeholder: string; key: keyof typeof form; isEditable?: boolean}) => (
    <TextInput
      ...
      style={[styles.input,{  cursorColor:"#fff", selectionColor:"#fff", backgroundColor: themeColor.inputBackground, borderColor: themeColor.inputBorder, color: themeColor.text}, errors[key] && { borderColor: themeColor.error}]}
      ...
      <View style={[styles.card,{backgroundColor:themeColor.inputBackground}]}>
        ...
        >
          <Text style={{ color: form.dob ? themeColor.text : themeColor.placeholder }}>
            {formatDate(form.dob) || "Select Date of Birth"}
          </Text>
        </TouchableOpacity>
